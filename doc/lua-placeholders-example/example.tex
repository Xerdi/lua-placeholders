...
\begin{document}
    ...
    Date example (a string whose payload value matches \texttt{YYYY-MM-DD}):\\

    \lstinline[style=TeX,morekeywords={param}]|\param{date example}|
    $\implies$
    \param{date example}\\
...
\npnoround
    ...
    \lstinline[style=TeX,morekeywords={rawparam}]|\rawparam{\jobname}{date example}|
    $\implies$
    \rawparam{\jobname}{date example}\\
