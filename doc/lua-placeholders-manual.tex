...
\begin{document}
    ...
    \begin{description}
        ...
        Internally, \cmd{\fortablerow} maintains a stack of in-progress iterations and rebinds every column to a global control sequence (\cmd{\token.set\_macro}) just before each invocation of \meta{csname}.
